...
- This type of model is all very data "hungry" so the more data included the better it work. Knowing this we wanted to gather as much house listing data as possible to train the model. 
